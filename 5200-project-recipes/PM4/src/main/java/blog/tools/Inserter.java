...
public class Inserter {
    ...
    public static void main(String[] args) throws SQLException {
	    ...
	    Users user1 = new Users("cat", "111111", "Wayne", "Lee", "wayne@gmail.com", "7811111111");
//	    user1 = usersDao.create(user1);
	
	    Date date = new Date();
	    
//	    Posts p1 = new Posts(10, "cat", "amazing!", date);
//	    p1 = postsDao.create(p1);
//	    Posts p2 = new Posts(11, "cat", "still amazing!", date);
//	    p2 = postsDao.create(p2);
	    
	    Comments c1 = new Comments(10, "Those dumplings look amazing!", date, "cat", 4);
	    commentsDao.create(c1);
	    Comments c2 = new Comments(11, "Those dumplings taste amazing!", date, "cat", 5);
	    commentsDao.create(c1);
	    

	    
//	    Comments c2 = new Comments(8, "Those dumplings look amazing!", date, "123123", 3);
//	    commentsDao.create(c2);
//	    Comments c3 = new Comments(4, "Those dumplings look amazing!", date, "123123", 4);
//	    commentsDao.create(c3);
	    
//	    List<Comments> cList1 = commentsDao.getCommentsForUser(user1);
////		System.out.format("Reading person: u:%s f:%s l:%s \n",
////			p1.getUserName(), p1.getFirstName(), p1.getLastName());
//		for(Comments p : cList1) {
//			System.out.format("Looping persons: ur:%s u:%s f:%s l:%s \n",
//				p.getUserName(), p.getCommentContent(), p.getCommentId(), p.getPostId());
//		}
    }
}
